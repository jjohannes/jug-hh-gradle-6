...
* Apply `java-test-fixtures` plugin in addition to `java-library` https://docs.gradle.org/6.2.2/userguide/java_testing.html#sec:java_test_fixtures[(doc)]
...
Depend on the test fixture _variant_ of another project/component https://docs.gradle.org/6.2.2/userguide/java_testing.html#consuming_test_fixtures_of_another_project[(doc)]
...
Functionality of `java-library` plugin https://docs.gradle.org/6.2.2/userguide/feature_variants.html[(doc)]
...
Depend on a feature variant of another project/component https://docs.gradle.org/6.2.2/userguide/feature_variants.html#sec::consuming_feature_variants[(doc)]
